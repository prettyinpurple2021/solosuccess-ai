  ...
  return (
    <div className="min-h-screen bg-[#020005] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg relative z-10">
        {/* Restored Glitch Header with NEW Text */}
        <div className="text-center mb-8">
           <h1 className="text-4xl font-bold font-boss text-transparent bg-clip-text bg-gradient-to-r from-[#FF1FAF] to-[#B621FF] mb-2 glitch-text" data-text="CREATE YOUR ACCOUNT">
            CREATE YOUR ACCOUNT
          </h1>
