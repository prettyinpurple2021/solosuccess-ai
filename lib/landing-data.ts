...
export const aiAgents: AIAgent[] = [
  ...
  },
  {
    ...
    specialty: "Legal Compliance & Documentation",
    image: "/images/agents/lumi.png",
    description: "Provides knowledgeable and precise guidance on legal requirements and document generation.",
    skills: ["Legal Requirements", "Document Generation", "Compliance Guidance", "Contract Creation"],
    personality: {
      tone: "Knowledgeable and precise",
      approach: "Thorough and detail-oriented",
      strengths: ["Legal expertise", "Risk assessment", "Document organization"],
    },
    color: "from-indigo-500 to-purple-500",
    avatar: "/images/agents/lumi.png",
    isVoiceEnabled: true,
    specialties: ["Legal Requirements", "Document Generation", "Compliance Guidance", "Contract Creation"],
  },
  {
    id: "vex",
    name: "Vex",
