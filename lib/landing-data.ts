...
export const aiAgents: AIAgent[] = [
  {
    ...
    skills: ["SPADE Framework", "Strategic Planning", "Decision Analysis", "Stakeholder Management", "Communication Strategy"],
    personality: {
    ...
    isVoiceEnabled: true,
    specialties: ["SPADE Framework", "Strategic Planning", "Decision Analysis", "Stakeholder Management", "Communication Strategy"],
  },
  {
    id: "blaze",
    name: "Blaze",
  ...
  },
  {
    ...
    skills: ["Five Whys Analysis", "Root Cause Investigation", "Quality Testing", "Process Optimization", "System Monitoring"],
    personality: {
    ...
    isVoiceEnabled: true,
    specialties: ["Five Whys Analysis", "Root Cause Investigation", "Quality Testing", "Process Optimization", "System Monitoring"],
  },
  {
    id: "lumi",
    name: "Lumi",
    ...
    description: "Your proactive Compliance & Ethics Co-Pilot who transforms legal anxiety into competitive advantage through automated compliance and trust-building systems.",
    skills: ["GDPR/CCPA Compliance", "Policy Generation", "Consent Management", "Trust Scoring", "Legal Documents", "Risk Assessment"],
    personality: {
    ...
    isVoiceEnabled: true,
    specialties: ["GDPR/CCPA Compliance", "Policy Generation", "Consent Management", "Trust Scoring", "Legal Documents", "Risk Assessment"],
  },
  {
    id: "vex",
    name: "Vex",
