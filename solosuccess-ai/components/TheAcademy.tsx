...
export const TheAcademy: React.FC = () => {
    ...
    const handleFinish = async () => {
        ...
        if (result) {
            ...
            // PRODUCTION NOTE:
            // Save the session results (score, feedback) to a 'training_history' table.
            // This allows the user to track their improvement over time.
    ...
    return (
        <div className="min-h-[85vh] flex flex-col animate-in fade-in duration-500">
            ...
            {!activeScenario ? (
                    ...
                    {SCENARIOS.map(scenario => (
                        ...
                        >
                            <div className={`absolute top-0 left-0 w-full h-1 ${
                                scenario.difficulty === 'ROOKIE' ? 'bg-emerald-500' :
                            ...
                            <div className="flex justify-between items-start mb-4">
                                <div className={`text-[10px] font-bold px-2 py-1 rounded uppercase ${
                                    scenario.difficulty === 'ROOKIE' ? 'bg-emerald-900/30 text-emerald-500' :
                ...
                <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-8 h-[600px]">
