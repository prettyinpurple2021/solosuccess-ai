...
export const TheUplink: React.FC = () => {
    ...
    return (
        <div className="min-h-[85vh] flex flex-col animate-in fade-in duration-500 relative overflow-hidden">
            ...
            {/* Header */}
             <div className="relative z-10 mb-6 flex items-end justify-between border-b border-zinc-800 pb-6">
                <div>
                    ...
                    <h2 className="text-4xl font-black text-white tracking-tighter">THE UPLINK</h2>
                ...
                <div className="flex items-center gap-2">
                    {active ? (
                         <button 
                            onClick={disconnect}
                            className="flex items-center gap-2 px-6 py-3 bg-red-600 hover:bg-red-500 text-white rounded font-bold text-xs uppercase tracking-widest transition-all shadow-lg shadow-red-900/50 animate-pulse"
                         >
                        ...
                        <div className="flex gap-4">
                            <select 
                                ...
                                className="bg-zinc-900 border border-zinc-800 text-white rounded px-4 py-2 text-xs font-bold uppercase tracking-wider focus:border-emerald-500 outline-none"
                            >
                            ...
                            <button 
                                onClick={connect}
                                className="flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded font-bold text-xs uppercase tracking-widest transition-all shadow-lg shadow-emerald-900/20"
                            >
