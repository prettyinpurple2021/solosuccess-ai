...
export const IdeaIncinerator: React.FC = () => {
  ...
  const handleIgnite = async () => {
    ...
    // PRODUCTION NOTE: 
    // This feature currently does not persist history.
    // In production, consider saving 'Incineration Sessions' to the Vault or a database history table.
                            ...
                            <div className="shrink-0 flex items-center gap-4">
                                <div className="text-right">
                                    ...
                                    <p className={`text-4xl font-black ${
                                        result.survivalScore > 80 ? 'text-emerald-500' :
                                ...
                                <div className={`w-16 h-16 rounded-full border-4 flex items-center justify-center ${
                                    result.survivalScore > 80 ? 'border-emerald-900/50 bg-emerald-900/20' :
