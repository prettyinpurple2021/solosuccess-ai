...
export function IntegrationHub() {
  ...
  const integrations: Integration[] = [
    ...
    },
    {
      id: "stripe",
      name: "Stripe",
      description: "Track revenue, payments, and financial metrics automatically",
      icon: CreditCard,
      category: "finance",
      isConnected: true,
      isPremium: true,
      features: ["Revenue tracking", "Payment notifications", "Financial analytics", "Subscription management"],
      setupSteps: [
