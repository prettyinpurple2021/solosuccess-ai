  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh w-[256px] transition-[left,right,width] ease-linear md:flex",
            side === "left"
  ...
  return (
    <main
      ...
      className={cn(
        ...
        // Using exact width to match sidebar: 16rem = 256px
        !isMobile && "md:ml-[256px] md:peer-data-[state=collapsed]:ml-[48px] transition-[margin] duration-200 ease-linear",
        className
      )}
      {...props}
    />
