...
('power_user', 'Power User', 'Reached level 10', '⚡', 'progression', 500, '{"user_level": 10}'),
('goal_crusher', 'Goal Crusher', 'Completed 5 goals', '💪', 'goals', 400, '{"goals_completed": 5}')
ON CONFLICT (name) DO NOTHING;

-- Insert sample template categories
INSERT INTO template_categories (category, icon, description) VALUES
('Business Strategy', '🎯', 'Strategic planning and business development templates'),
('Productivity', '⚡', 'Task management and productivity optimization templates'),
('Marketing', '📢', 'Marketing and brand development templates'),
('Wellness', '🧘', 'Wellness and work-life balance templates'),
('Decision Making', '🤔', 'Decision frameworks and analysis templates'),
('Creativity', '🎨', 'Creative thinking and innovation templates')
